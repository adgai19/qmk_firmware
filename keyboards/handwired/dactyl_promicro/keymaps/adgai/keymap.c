...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_6x6(
        ...
        KC_EQL,KC_QUOT,ALT_SHFT,KC_LEFT,KC_RGHT,KC_SPC ,                                       KC_ENT , KC_UP  ,KC_DOWN,KC_LBRC,KC_RBRC,TT(_LOWER),
                                                OSL(_LOWER),KC_LEFT_SHIFT,KC_LEFT_GUI,       KC_ENT,KC_LALT,TG(_RAISE) ,
                                                                KC_LEFT_CTRL,        KC_SPC,
    ...
    [_LOWER] = LAYOUT_6x6(
        ...
        _______,KC_PERC,KC_CIRC,KC_LCBR,KC_RCBR,KC_TILD,                                       KC_AMPR,KC_P1  ,KC_P2  ,KC_P3  ,KC_PSLS,_______,
