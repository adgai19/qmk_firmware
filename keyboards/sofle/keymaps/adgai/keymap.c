...
[_QWERTY] = LAYOUT(
  ...
  KC_LSFT , KC_Z    , KC_X    , KC_M    , KC_C    , KC_V       , KC_MUTE,                       KC_BTN3,     KC_K        , KC_L       , KC_COMM , KC_DOT , KC_SLSH , KC_RSFT,
                 KC_LEFT,KC_RGHT,LOWER, CTRL, GUI,      ENT,  SPC,RAISE, KC_UP, KC_DOWN
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
...
[_LOWER] = LAYOUT(
  ...
  QK_BOOT, KC_PERC , KC_CIRC , KC_LCBR , KC_RCBR , KC_TILD , _______,                    _______ , KC_AMPR , KC_1    , KC_2    , KC_3    , KC_0    , KC_SLSH,
...
[_RAISE] = LAYOUT(
  ...
  _______   , _______ , KC_MS_L , KC_MS_D , KC_MS_R , _______ ,                                     _______ , KC_LEFT , KC_DOWN , KC_RIGHT , CS_TAB  , _______,
  _______ , _______ , KC_BTN3 , KC_BTN1 , KC_BTN2 , _______ ,_______,                   _______ , _______ , _______ , KC_MPRV , KC_MNXT  , _______ , _______,
                         _______, _______, _______, _______, _______,       _______, _______, _______, _______, _______
),
/* ADJUST
 * ,-----------------------------------------.                    ,-----------------------------------------.
...
const uint16_t PROGMEM test_combo2[] = {KC_ESC, KC_N, COMBO_END};
const uint16_t PROGMEM test_combo3[] = {KC_ESC, KC_E, COMBO_END};
const uint16_t PROGMEM test_combo4[] = {KC_ESC, KC_O, COMBO_END};
